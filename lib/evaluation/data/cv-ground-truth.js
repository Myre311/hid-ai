 ...
 */
// Tous les tests bbox utilisent maintenant des vraies photos COCO val2017
// (CC-BY-4.0, usage commercial OK). Annotations bbox extraites directement
// du fichier officiel instances_val2017.json et normalisées en [0,1].
export const CV_GROUND_TRUTH = [
  {
    id: "img-1",
    image: "/evaluation/cv/bboxes/img-1.jpg",
    label: "Feux de signalisation",
    instruction:
      "Annotez chaque feu tricolore visible. Précisez sa position (mât, suspendu, mural).",
...
/**
 * Mode polygone : 1 vraie photo avec un objet complexe à contourner.
 * Vrai usage en annotation pro = tracer le contour précis d'un avion sur tarmac
 * (la silhouette comporte nez, fuselage, ailes, ailerons, queue → forme non-triviale).
 *
 * Photo COCO val2017 #478862 (CC-BY-4.0). Avion couvre les 4 quadrants
 * avec 130 points de segmentation officiels comme référence.
 *
 * Scoring actuel : ≥ 6 points + couverture des 4 quadrants (simple).
 * Une amélioration future pourrait scorer en IoU contre le mask officiel.
 */
export const CV_POLYGON_TARGET = {
  id: "poly-1",
  image: "/evaluation/cv/polygon/poly-1.jpg",
  label: "Contour d'avion sur tarmac",
  instruction:
    "Tracez un polygone précis qui contourne la silhouette de l'avion (nez, fuselage, ailes, queue). Au moins 6 points, idéalement 12+ pour une bonne précision. Cliquez pour ajouter des points puis « Fermer le polygone ».",
  quadrants: 4,
  minPoints: 6,
};
