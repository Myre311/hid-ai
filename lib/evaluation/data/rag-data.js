  ...
  quiz: [
    {
      ...
      options: {
        A: "Compiler du code Rust.",
        B: "Indexer et chercher des embeddings par similarité (cosine, dot-product) à grande échelle.",
    ...
    },
    {
      ...
      options: {
        A: "Lexicale est plus récente et plus performante.",
        B: "C'est exactement la même chose.",
        C: "Sémantique = compréhension de sens via embeddings ; lexicale = matching de mots-clés (BM25, TF-IDF).",
    ...
    {
      id: "q-04",
      question: "Avant RAG, un LLM produisait 25 hallucinations factuelles sur 100 réponses. Après mise en place d'un système RAG sur des manuels d'ingénierie, on en mesure 15 sur 100. Quelle est la réduction relative obtenue ?",
      options: { A: "10 % (différence absolue uniquement)", B: "25 %", C: "60 %", D: "40 %" },
      answer: "D",
    },
    {
      id: "q-05",
      question: "Quelle taille de chunk est généralement recommandée ?",
      options: { A: "10 tokens maximum.", B: "200-500 tokens, avec recouvrement de 10-20%.", C: "Pas de chunking, on passe tout le document.", D: "100 000 tokens." },
      answer: "B",
    },
    {
      id: "q-06",
      question: "Ragas est un framework pour :",
      options: { A: "Compresser les embeddings.", B: "Évaluer la qualité d'un système RAG (faithfulness, answer relevancy, context precision).", C: "Faire du fine-tuning LoRA.", D: "Gérer le déploiement." },
      answer: "B",
    },
    {
      id: "q-07",
      ...
      options: {
        A: "Il faut traduire en latin d'abord.",
        B: "Un embedding entraîné uniquement sur du code Python.",
        C: "Aucun embedding ne marche en français.",
        D: "Un modèle multilingue (text-embedding-3, bge-multilingual, mistral-embed).",
      },
      answer: "D",
    },
    {
    ...
    },
    {
      ...
      options: { A: "Context Precision", B: "Answer Relevancy", C: "Faithfulness", D: "Throughput" },
      answer: "C",
    },
  ],
};
