...
export const NLP_FINETUNING_DATA = {
  quiz: [
    // ── 4 questions contextualisées OHADA / Afrique ──
    {
      ...
      options: {
        A: "Pre-training from scratch sur tout le corpus OHADA",
        B: "Fine-tuning d'un Mistral 7B avec LoRA sur un dataset d'instruction Q&A du Droit OHADA",
    ...
    },
    {
      ...
      options: {
        A: "CSV avec colonnes texte",
        B: "JSONL avec champs instruction / input / output",
        C: "XML avec balises sémantiques",
        D: "Plain text séparé par lignes",
      },
      answer: "B",
    },
    {
      ...
      options: {
        A: "Full fine-tuning sur GPU A100",
        B: "LoRA avec rank=8 ou QLoRA 4-bit (les deux acceptés)",
        C: "Inference only sans fine-tuning",
    ...
    },
    {
      ...
      options: {
        A: "Notebook Jupyter avec les poids",
        B: "Modèle quantifié + API Dockerisée (FastAPI) prête à déployer",
        C: "Fichier .pkl envoyé par email",
        D: "Modèle publié sur HuggingFace Hub public",
      },
      answer: "B",
    },
    // ── 6 questions techniques classiques ──
    {
      ...
      options: {
        A: "LoRA gèle les poids et ajoute des matrices de rang faible ; QLoRA fait la même chose mais sur un modèle quantifié 4-bit, réduisant drastiquement la VRAM.",
    ...
    },
    {
      ...
      options: {
        ...
        C: "L'incertitude du modèle sur une séquence — plus c'est bas, plus le modèle est confiant.",
    ...
    },
    {
      ...
      options: {
        A: "Closed source, payants",
        B: "Open weight (Apache 2.0 / Llama Community License) — utilisables pour le fine-tuning",
    ...
    },
    {
      ...
      options: {
        ...
        D: "Aucun, on n'utilise pas d'epochs en fine-tuning",
      },
      answer: "A",
    },
    {
      ...
      options: {
        ...
        B: "Pour streaming ligne par ligne sans tout charger en mémoire",
        C: "C'est plus joli visuellement",
        D: "Uniquement pour les fichiers de moins de 100 lignes",
      },
      answer: "B",
    },
    {
      ...
      options: {
        ...
        B: "Évaluation humaine + benchmark adapté à la tâche (perplexity + métriques métier)",
