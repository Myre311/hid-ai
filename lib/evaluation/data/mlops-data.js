...
export const MLOPS_DATA = {
  ...
  architecture_steps: {
    ...
    deployment: "Deployment (Docker + Kubernetes + canary)",
    monitoring: "Monitoring & alerting (Prometheus + drift)",
  },
  ...
  quiz: [
    ...
    },
    {
      ...
      options: {
        A: "Rien, c'est normal.",
        B: "Re-clarifier les guidelines d'annotation, faire un calibration round, et exclure les annotateurs systématiquement divergents.",
    ...
    },
    {
      ...
      options: {
        A: "Monitoring continu (data drift, concept drift, métriques business) avec alerting Prometheus.",
