...
export const TESTS = [
  {
    ...
    icon: "ScanEye",
    // 1re étape = porte d'entrée : seuil abaissé à 50 (le vrai filtrage se
    // fait sur les tests suivants) et cible 20 min (10 min était trop court
    // pour 5 images multi-instances + polygone + tracking).
    passing_score: 50,
    target_minutes: 20,
  },
  {
