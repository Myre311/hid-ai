...
import { aiNativeLevel } from "@/lib/evaluation/aiNativeScore";
...
export function evaluationCompletedTemplate({
  ...
  const level = aiNativeLevel(aiNativeScore);
                ...
                <tr>
                  <td>
                    ...
                    <p style="margin:0;font-size:48px;line-height:1;font-weight:600;color:#fafafa;">
                      ${aiNativeScore} <span style="font-size:18px;color:#71717a;">/ 1000</span>
                    </p>
...
AI-Native Score : ${aiNativeScore} / 1000 (${level.label})
