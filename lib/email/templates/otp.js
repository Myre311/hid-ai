        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:${C.card};border:1px solid ${C.line};border-radius:14px;">
          ...
          <tr>
            <td style="padding:32px 40px 24px;border-bottom:1px solid ${C.line};">
              <img src="https://hid-ai.com/brand/hid-ai-email-logo.png" alt="HID AI" width="158" height="45" style="display:block;border:0;outline:none;text-decoration:none;height:45px;width:158px;" />
              <div style="margin-top:14px;font-size:11px;color:${C.muted};text-transform:uppercase;letter-spacing:0.22em;">Vérification du compte</div>
            </td>
          </tr>
