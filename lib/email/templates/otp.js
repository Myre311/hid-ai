...
export function otpEmailTemplate({ code, ttlMinutes = 5 }) {
  ...
  const C = {
    ...
    dark: "#0a0a0a", // bandeau d'en-tête sombre (logo blanc)
    onDark: "#a1a1aa", // texte secondaire sur le bandeau sombre
  };
  const sans =
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${C.page};">
      <tr><td align="center" style="padding:40px 16px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:${C.card};border:1px solid ${C.line};border-radius:14px;">
          ...
          <!-- Header = IMAGE unique (fond noir + logo blanc intégrés).
               Gmail strippe les fonds td mais rend toujours les images :
               le bandeau sombre fait partie de l'image, impossible à blanchir. -->
          <tr>
            <td style="padding:0;font-size:0;line-height:0;mso-line-height-rule:exactly;">
              <img src="https://hid-ai.com/brand/hid-ai-email-header.png" alt="HID AI" width="600" style="display:block;width:100%;max-width:600px;height:auto;border:0;outline:none;text-decoration:none;" />
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:34px 40px 36px;">
              <div style="font-size:11px;color:${C.muted};text-transform:uppercase;letter-spacing:0.22em;margin-bottom:14px;">Vérification du compte</div>
