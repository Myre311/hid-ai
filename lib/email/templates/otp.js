    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${C.page};">
      <tr><td align="center" style="padding:40px 16px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:${C.card};border:1px solid ${C.line};border-radius:14px;">
          ...
          <!-- Header (bandeau sombre + logo blanc) — bgcolor= attribut HTML
               car Gmail strippe le background CSS même sur un td contenu -->
          <tr>
            <td bgcolor="${C.dark}" style="background-color:${C.dark};background:${C.dark};padding:34px 40px 30px;">
              ...
              <div style="margin-top:16px;font-size:11px;color:${C.onDark};text-transform:uppercase;letter-spacing:0.22em;">Vérification du compte</div>
            </td>
          </tr>
