          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr><td align="center" style="background:${C.codeBg};border:1px solid ${C.line};border-radius:10px;padding:28px 16px;">
                  <div style="font-family:${monoFont};font-size:42px;font-weight:700;letter-spacing:0.14em;color:${C.ink};">${spaced}</div>
