...
export async function compressImage(
  file,
  // v2 — compression plus agressive pour fiabiliser l'upload depuis mobiles
  // (connexions instables + limite Vercel 4.5 MB body).
  // Cible : ~150-400 KB par fichier, parfaitement lisible pour la pièce d'identité.
  { maxSide = 1200, quality = 0.72, passthroughBytes = 200 * 1024 } = {}
) {
